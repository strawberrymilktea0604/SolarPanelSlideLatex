            ...
            \begin{tcolorbox}[
                ...
                \begin{columns}
                    ...
                    \begin{column}{0.15\textwidth}
                        ...
                        \includegraphics[width=0.8cm, keepaspectratio]{images/TongQuan/icons/khaiquat.png}
                    \end{column}
                    % Cột chứa Tiêu đề
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.58\textwidth}
            ...
            \begin{tcolorbox}[
                ...
                \begin{tabular}{@{}c l@{}}
                    ...
                    \includegraphics[height=1em]{images/PhuongPhap/icons/docao.png} & 
                    \parbox{0.88\linewidth}{\scriptsize \textbf{Độ cao:} 25m so với mặt đất.} \\[0.8ex] % Giảm khoảng cách dòng
                    
                    \includegraphics[height=1em]{images/PhuongPhap/icons/gocchup.png} & 
                    \parbox{0.88\linewidth}{\scriptsize \textbf{Góc chụp:} Vuông góc ($\approx 90^\circ$).} \\[0.8ex]
                    
                    \includegraphics[height=1em]{images/PhuongPhap/icons/thoigian.png} & 
        ...
        \begin{column}{0.40\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=south west, inner sep=0] (image) at (0,0) {\includegraphics[width=\linewidth, keepaspectratio]{images/PhuongPhap/uav.png}};
            \end{tikzpicture}
        \end{column}
