...
\begin{frame}
        ...
        \begin{column}{0.31\textwidth}
            \begin{tcolorbox}[mycardstyle]
                \begin{minipage}[t][2.95cm][t]{\linewidth}
                    ...
                    % Icon + Tiêu đề
                    \centering
                    \includegraphics[height=0.6cm]{images/TongQuan/icons/dienmattroiquymolon.png}
                    \par\vspace{0.02cm}
                ...
                \begin{tikzpicture}
                    \clip [rounded corners=6pt] (0,0) rectangle (\linewidth, 1.1cm); 
                    \node[anchor=south west, inner sep=0] at (0,0) {\includegraphics[width=\linewidth, height=1.1cm]{images/TongQuan/trungnam.jpg}};
                \end{tikzpicture}
            \end{tcolorbox}
        \end{column}\hfill
        ...
        \begin{column}{0.31\textwidth}
            \begin{tcolorbox}[mycardstyle]
                \begin{minipage}[t][2.95cm][t]{\linewidth}
                    \raggedright
                    \centering
                    \includegraphics[height=0.6cm]{images/TongQuan/icons/dienmattroiapmai.png}
                    \par\vspace{0.02cm}
                ...
                \begin{tikzpicture}
                    \clip [rounded corners=6pt] (0,0) rectangle (\linewidth, 1.1cm);
                    \node[anchor=south west, inner sep=0] at (0,0) {\includegraphics[width=\linewidth, height=1.1cm]{images/TongQuan/apmai.png}};
                \end{tikzpicture}
            \end{tcolorbox}
        \end{column}\hfill
        ...
        \begin{column}{0.31\textwidth}
            \begin{tcolorbox}[mycardstyle]
                \begin{minipage}[t][2.95cm][t]{\linewidth}
                    \raggedright
                    \centering
                    \includegraphics[height=0.6cm]{images/TongQuan/icons/dienmattroidoclap.png}
                    \par\vspace{0.02cm}
                ...
                \begin{tikzpicture}
                    \clip [rounded corners=6pt] (0,0) rectangle (\linewidth, 1.1cm);
                    \node[anchor=south west, inner sep=0] at (0,0) {\includegraphics[width=\linewidth, height=1.1cm]{images/TongQuan/doclap.png}};
                \end{tikzpicture}
            \end{tcolorbox}
        \end{column}\hfill
    ...
    \parbox{0.95\textwidth}{
        \footnotesize \textbf{Tổng kết:} Sự cộng hưởng giữa tiềm năng bức xạ dồi dào và hành lang pháp lý khuyến khích tự sản tự tiêu tạo nền tảng vững chắc để Việt Nam phát triển năng lượng mặt trời hiệu quả và bền vững.
    }}
\end{frame}
...
\begin{frame}
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.32\textwidth}
            ...
            \begin{tikzpicture}
                \clip [rounded corners=6pt] (0,0) rectangle (3.6cm, 1.4cm);
                \node[inner sep=0pt, anchor=center] at (1.8cm, 0.7cm) {\includegraphics[width=3.6cm, height=1.4cm]{images/TongQuan/suythoaiquanghoc.png}};
            \end{tikzpicture}
        \end{column}
        ...
        \begin{column}{0.32\textwidth}
            ...
            \begin{tikzpicture}
                \clip [rounded corners=6pt] (0,0) rectangle (3.6cm, 1.4cm);
                \node[inner sep=0pt, anchor=center] at (1.8cm, 0.7cm) {\includegraphics[width=3.6cm, height=1.4cm]{images/TongQuan/matketnoidien.jpg}};
            \end{tikzpicture}
        \end{column}
        ...
        \begin{column}{0.32\textwidth}
            ...
            \begin{tikzpicture}
                \clip [rounded corners=6pt] (0,0) rectangle (3.6cm, 1.4cm);
                \node[inner sep=0pt, anchor=center] at (1.8cm, 0.7cm) {\includegraphics[width=3.6cm, height=1.4cm]{images/TongQuan/huhongphancung.png}};
            \end{tikzpicture}
        \end{column}
    \end{columns}
...
\begin{frame}[t]
    \frametitle{CÁC PHƯƠNG PHÁP KIỂM TRA \& ĐÁNH GIÁ}
    \vspace{-0.3cm}
    ...
    \begin{columns}[T, onlytextwidth]
        ...
        \begin{column}{0.24\textwidth}
            ...
            \begin{itemize}
                ...
                \item Tốc độ nhanh, chi phí thấp.
                \item \textbf{Hạn chế:} Bỏ sót lỗi ẩn sâu.
            \end{itemize}
        \end{column}\hfill
    ...
    \vfill
    \centering
    \small \textit{`\textbf{Khám lâm sàng}' $\to$ `\textbf{Xét nghiệm y khoa}' để kết luận chính xác}
\end{frame}
