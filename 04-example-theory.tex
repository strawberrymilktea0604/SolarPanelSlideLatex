...
\begin{frame}
    ...
    % --- 1. ĐỊNH NGHĨA ---
    \footnotesize
    \textbf{Định nghĩa:} Là thiết bị bay không người lái tự động dùng để thu thập dữ liệu từ trên cao. Thường được tích hợp camera RGB, camera nhiệt hoặc cảm biến chuyên dụng.
    ...
    \resizebox{0.75\textwidth}{!}{% Resize nhỏ hơn theo yêu cầu (0.82 -> 0.75)
        \begin{tikzpicture}[
            ...
            \node [labelstyle] at (step3.south) {Phân tích lỗi};
...
\begin{frame}[t]
    ...
    \vspace{0.5cm}
    \centering
    {\large \bfseries \textcolor{red}{Chi phí cao, khó triển khai trên quy mô lớn và yêu cầu thiết bị chuyên dụng.}}
...
\begin{frame}
    ...
    \begin{table}
        ...
        \resizebox{0.95\textwidth}{!}{
            ...
            % Giảm giãn dòng xuống 1.0 để tiết kiệm chiều cao cho phần dưới
    ...
    \end{table}
    \vspace{-0.1cm}
    % Tăng size chữ lên scriptsize (lớn hơn tiny)
    {\scriptsize
        \textbf{\textcolor{red}{Khoảng trống nghiên cứu}}
        \begin{itemize}
            \setlength\itemsep{0pt} % Giảm khoảng cách giữa các item
            \item Chưa có nhiều nghiên cứu xây dựng chuỗi xử lý khép kín.
            \item Nhiều nghiên cứu độ chính xác cao phụ thuộc ảnh nhiệt/EL, chi phí lớn.
            \item Các nghiên cứu ảnh RGB còn xử lý rời rạc, độ chính xác chưa cao do chưa sử dụng model phù hợp.
...
\begin{frame}
    ...
    \vspace{0.25cm}
    \textbf{Chỉ số đánh giá:} Accuracy, Recall, Precision, F1-score.
\end{frame}
    ...
    \begin{columns}[T, onlytextwidth]
        ...
        \begin{column}{0.48\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node[anchor=center] at (0.5\linewidth, 2.5cm) {\includegraphics[width=1.7\linewidth]{images/PhuongPhap/uav.png}};
            \end{tikzpicture}
        \end{column}
    \end{columns}
\end{frame}
...
\label{toancanh}
    ...
    \begin{center}
        ...
        \raisebox{-0.3em}{\includegraphics[height=1.2em]{images/PhuongPhap/icons/thoigian.png}} \textbf{Thời gian:} 7:00 - 9:00
    \end{center}
...
\label{anhthuthapboiuav}
	...
	\begin{center}
        ...
        \begin{tcolorbox}[
            ...
            \small 130 ảnh quang học độ phân giải cao, sắc nét.
        \end{tcolorbox}
	\end{center}
\end{frame}
...
\begin{frame} 
    ...
    % --- HÀNG 1: 4 ẢNH AUGMENTATION ---
    \begin{columns}[c, onlytextwidth]
        \begin{column}{0.24\textwidth}
            \centering
            % Thêm width=\linewidth để đảm bảo ảnh không rộng hơn cột
            \includegraphics[width=\linewidth, height=2.8cm, keepaspectratio]{images/PhuongPhap/dataaugment/rotation.png}
        \end{column}
        \begin{column}{0.24\textwidth}
            \centering
            \includegraphics[width=\linewidth, height=2.8cm, keepaspectratio]{images/PhuongPhap/dataaugment/flip.png}
        \end{column}
        \begin{column}{0.24\textwidth}
            \centering
            \includegraphics[width=\linewidth, height=2.8cm, keepaspectratio]{images/PhuongPhap/dataaugment/color.png}
        \end{column}
        \begin{column}{0.24\textwidth}
            \centering
            \includegraphics[width=\linewidth, height=2.8cm, keepaspectratio]{images/PhuongPhap/dataaugment/noise.png}
        \end{column}
    \end{columns}
    
    \vspace{0.3cm} % Khoảng cách giữa 2 khối
