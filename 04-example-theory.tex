    ...
    \resizebox{\textwidth}{!}{
        \begin{tikzpicture}
            ...
            \node[inner sep=0pt] (icon1) at (0, 1.8) {
                \includegraphics[height=1.5cm]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/icons/camera.png}
            };
            ...
            \node[inner sep=0pt] (icon2) at (\hdist, 1.8) {
                \includegraphics[height=1.5cm]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/icons/xulyanh.png}
            };
            ...
            \node[inner sep=0pt] (icon3) at ({2*\hdist}, 1.8) {
                \includegraphics[height=1.5cm]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/icons/train.png}
            };
            ...
            \node[inner sep=0pt] (icon4) at ({3*\hdist}, 1.8) {
                \includegraphics[height=1.5cm]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/icons/classify.png}
            };
...
\begin{frame}[shrink=5] 
    ...
    \begin{columns}[T]
        ...
        \begin{column}{0.58\textwidth}
            % Giảm margin và padding của box tổng xuống mức tối thiểu
            \begin{tcolorbox}[
                colback=bglight, 
                colframe=bglight, 
                arc=5pt, 
                boxrule=0pt,
                left=1mm, right=1mm, top=1mm, bottom=1mm, % Ép lề cực nhỏ
                boxsep=0pt % Bỏ đệm nội dung
            ]
                % --- Phần 1: Thiết bị ---
                % Dùng small thay vì large cho tiêu đề
                \textbf{\small Thiết bị} 
                
                % Dùng scriptsize (rất nhỏ) cho nội dung
                \scriptsize{DJI Phantom 4 RTK với cảm biến 20MP và công nghệ định vị RTK độ chính xác centimet.}
                
                \vspace{0.3em} % Giảm khoảng cách
                
                % --- Phần 2: Thông số ---
                \textbf{\small Thông số bay tối ưu}
                \vspace{0.2em}
                
                % Bảng: Giảm khoảng cách dòng (arraystretch)
                \renewcommand{\arraystretch}{0.8} 
                \begin{tabular}{@{}c l@{}}
                    % Giảm kích thước icon xuống 1em
                    \includegraphics[height=1em]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/icons/docao.png} & 
                    \parbox{0.88\linewidth}{\scriptsize \textbf{Độ cao:} 25m so với mặt đất.} \\[0.8ex] % Giảm khoảng cách dòng
                    
                    \includegraphics[height=1em]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/icons/gocchup.png} & 
                    \parbox{0.88\linewidth}{\scriptsize \textbf{Góc chụp:} Vuông góc ($\approx 90^\circ$).} \\[0.8ex]
                    
                    \includegraphics[height=1em]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/icons/thoigian.png} & 
                    \parbox{0.88\linewidth}{\scriptsize \textbf{Thời gian:} 9:00 - 11:00 sáng.} \\
                \end{tabular}
                ...
                \begin{tcolorbox}[
                    ...
                    title=Kết quả,
                    coltitle=white,
                    fonttitle=\bfseries\scriptsize, % Font tiêu đề nhỏ
                    colback=bglight,
                    colframe=borderblue,
                    attach boxed title to top left={xshift=2mm, yshift*=-2mm}, % Đẩy tiêu đề sát hơn
                    boxed title style={colback=borderblue, sharp corners, rounded corners=southeast, arc=3pt, size=small}, % size=small làm tiêu đề gọn hơn
                    boxrule=0.5pt,
                    arc=3pt,
                    left=1mm, right=1mm, top=4pt, bottom=1mm, % Ép lề box con
                    boxsep=0pt
                ]
                    \scriptsize 130 ảnh quang học độ phân giải cao, sắc nét, có tọa độ chính xác.
                \end{tcolorbox}
            \end{tcolorbox}
        \end{column}
        ...
        \begin{column}{0.40\textwidth}
            ...
            \begin{tikzpicture}
                ...
                \node [anchor=south west, inner sep=0] (image) at (0,0) {\includegraphics[width=\linewidth, keepaspectratio]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/uav.png}};
            \end{tikzpicture}
        \end{column}
...
\begin{frame}
    ...
    \begin{tikzpicture}
        ...
        \node[anchor=south west, inner sep=0] (image) at (0,0) {
            \includegraphics[width=\textwidth]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/tachchiet.png}
        };
...
\end{scope}
    ...
    \vspace{0.5em} % Khoảng cách giữa ảnh và box bên dưới
...
\begin{frame}
    ...
    \begin{tabular}{c|c}
        ...
        \begin{minipage}[c][\rowH][c]{\colW}
            ...
            \includegraphics[height=\imgH, keepaspectratio]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/dataaugment/rotation.png}
        \end{minipage}
        & 
        % --- GÓC TRÊN PHẢI ---
        \begin{minipage}[c][\rowH][c]{\colW}
            ...
            \vspace{2pt}
            \includegraphics[height=\imgH, keepaspectratio]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/dataaugment/flip.png}
        \end{minipage}
        \\ 
        ...
        \begin{minipage}[c][\rowH][c]{\colW}
            ...
            \vspace{2pt}
            \includegraphics[height=\imgH, keepaspectratio]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/dataaugment/color.png}
        \end{minipage}
        & 
        % --- GÓC DƯỚI PHẢI ---
        \begin{minipage}[c][\rowH][c]{\colW}
            ...
            \vspace{2pt}
            \includegraphics[height=\imgH, keepaspectratio]{C:/Users/minhk/Downloads/SolarPanelSlideLatex/images/PhuongPhap/dataaugment/noise.png}
        \end{minipage}
...
\begin{frame}[shrink] 
    ...
    \begin{columns}[t, onlytextwidth]
        ...
        % --- CỘT TRÁI ---
        \begin{column}{0.49\textwidth} % Tăng nhẹ độ rộng cột để chữ đỡ xuống dòng
            \begin{tcolorbox}[
                myboxstyle,
                colback=myBlueBack,
                colframe=myBlueLine,
            ]
                \small % Giảm cỡ chữ toàn bộ trong box
                ...
                Phân chia:
                \begin{itemize}
                    \setlength\itemsep{0pt} % Ép dòng sát nhau
                    \setlength\parskip{0pt}
        ...
        \begin{column}{0.49\textwidth}
            \begin{tcolorbox}[
                ...
                \begin{itemize}
                    \setlength\itemsep{2pt} % Giãn dòng vừa phải
                    \setlength\parskip{0pt}
                    \setlength\parsep{0pt}
                    
                    \item Augmentation: Xoay, Lật, Chỉnh màu, Nhiễu Gaussian.
                    \item Optimizer: Adam (LR $1e-4$).
                    \item Early Stopping: Patience = 5
                    \item Loss: Weighted Cross-Entropy \& Focal Loss.
                \end{itemize}
            \end{tcolorbox}
        \end{column}
