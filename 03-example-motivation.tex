    ...
    \begin{columns}[c]
        ...
        \begin{column}{0.33\textwidth}
            ...
            \begin{tikzpicture}
                \clip[rounded corners=8pt] (0,0) rectangle (3.6cm, 1.8cm);
                \node[anchor=center, inner sep=0pt] at (1.8cm, 0.9cm) {
                    \includegraphics[width=3.6cm, height=1.8cm, keepaspectratio=false]{images/DatVanDe/bivo.jpg}
                };
            \end{tikzpicture}
        \end{column}
    \end{columns}
