...
\begin{frame}
    \frametitle{TỔNG QUAN VỀ NĂNG LƯỢNG TÁI TẠO}
    
    \vspace{-0.2cm}
    
    % Hàng ngang trên: Nội dung text
    \justifying
    \footnotesize 
    Trong bối cảnh hiện nay, năng lượng tái tạo đang được ưu tiên phát triển mạnh mẽ trên toàn cầu, trong đó điện mặt trời là nguồn năng lượng chiếm tỷ trọng lớn nhất và có tốc độ tăng trưởng nhanh nhất.
    
    \vspace{0.15cm}
    
    % Hàng ngang dưới: Ảnh và Icon
    \begin{columns}[c, onlytextwidth]
        ...
        \begin{column}{0.12\textwidth}
            ...
            \includegraphics[height=1.35cm, keepaspectratio]{images/DatVanDe/iconenergy/1.png}\\[0.55cm]
            \includegraphics[height=1.35cm, keepaspectratio]{images/DatVanDe/iconenergy/2.png}\\[0.55cm]
            \includegraphics[height=1.35cm, keepaspectratio]{images/DatVanDe/iconenergy/3.png}
        \end{column}
        
        % Cột Giữa: Ảnh chính solar
        \begin{column}{0.7\textwidth}
            \centering
            % Tăng nhẹ chiều cao ảnh chính
            \includegraphics[width=\linewidth, height=4.95cm, keepaspectratio]{images/DatVanDe/solar.png}
        \end{column}
        
        % Cột Phải: Icon 4, 5, 6
        \begin{column}{0.12\textwidth}
            \centering
            \includegraphics[height=1.35cm, keepaspectratio]{images/DatVanDe/iconenergy/4.png}\\[0.55cm]
            \includegraphics[height=1.35cm, keepaspectratio]{images/DatVanDe/iconenergy/5.png}\\[0.55cm]
            \includegraphics[height=1.35cm, keepaspectratio]{images/DatVanDe/iconenergy/6.png}
        \end{column}
