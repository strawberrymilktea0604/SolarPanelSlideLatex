...
\label{Bungno}
    ...
    \vspace{-0.2cm}
    Hiện nay, năng lượng tái tạo đang được xem là \textcolor{red}{\textbf{hướng phát triển tất yếu}} nhằm thay thế các nguồn năng lượng hóa thạch truyền thống, trong đó:
    \vspace{0.1cm}
    ...
    % --- PHẦN 2: BIỂU ĐỒ VÀ HÌNH ẢNH ---
    \begin{columns}[c, onlytextwidth]
        
        % Cột trái: Ảnh Solar
        \begin{column}{0.48\textwidth}
            \centering
            % Bo góc tròn, giảm chiều cao xuống 4.0cm
            \begin{tikzpicture}
                \clip [rounded corners=8pt] (0,0) rectangle (\linewidth, 4.0cm);
                \node[anchor=center] at (0.5\linewidth, 2.0cm) {
                    \includegraphics[width=1.3\linewidth]{images/DatVanDe/solar.png}
                };
            \end{tikzpicture}
        \end{column}

        % Cột phải: Biểu đồ bùng nổ
        \begin{column}{0.48\textwidth}
            \centering
            % Bo góc tròn, chiều cao 4.0cm bằng cột bên trái
            \begin{tikzpicture}
                \clip [rounded corners=8pt] (0,0) rectangle (\linewidth, 4.0cm);
                \node[anchor=center] at (0.5\linewidth, 2.0cm) {
                    \includegraphics[width=\linewidth, height=4.0cm, keepaspectratio=false]{images/TongQuan/bieudobungno.png}
                };
            \end{tikzpicture}
        \end{column}
...
\begin{frame}
    ...
    \vspace{0cm}
    Từ bức tranh chung trên thế giới, Việt Nam cũng không nằm ngoài \textcolor{red}{\textbf{xu thế phát triển mạnh mẽ}} của điện mặt trời trong những năm gần đây.
    \vspace{0.1cm}
    ...
    \begin{itemize}
        ...
        \small % Tăng size chữ lên small
        \item Định hướng từ Quy hoạch điện VII với chủ trương, chính sách khuyến khích thu hút đầu tư.
        \item Nhiều trang trại điện mặt trời quy mô lớn đã đưa vào vận hành.
    \end{itemize}
...
\begin{frame}
    ...
    \vspace{0.0cm}
    Tuy nhiên, chính sự phát triển nhanh và quy mô lớn của các hệ thống pin mặt trời lại đặt ra một bài toán rất lớn về \textcolor{red}{\textbf{vận hành và bảo trì}}.
    \vspace{0.3cm}
    ...
    \vspace{1.3cm}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{minipage}[c][5.5cm][s]{\linewidth}
                \vspace{0cm}
                \hspace{0.3cm}\textbf{Kiểm tra thủ công truyền thống:}
                \vspace{-1.5cm}
...
\begin{frame}
    \frametitle{MỤC TIÊU NGHIÊN CỨU}
                    \textbf{Mục tiêu:} tạo ra một giải pháp cân bằng giữa độ \textcolor{red}{\textbf{chính xác và chi phí}}, giúp phát hiện sớm hư hỏng để tối ưu hóa vận hành.
    ...
    \begin{columns}[c, onlytextwidth] % Căn lề giữa
        ...
        \begin{column}{0.48\textwidth}
            \begin{objectivebox}{myOrangeBorder}{myOrangeBG}
                ...
                \raggedright
                Phát triển mô hình \textbf{Học sâu} để phân loại trạng thái tấm pin với độ chính xác cao.
            \end{objectivebox}
        \end{column}
    \end{columns}
\end{frame}
...
Để đảm bảo tính \textcolor{red}{\textbf{khả thi và phù hợp}} với điều kiện triển khai thực tế, nghiên cứu được giới hạn trong phạm vi cụ thể: 
    ...
    \begin{columns}[c] 
        \begin{column}{0.65\textwidth}
            \begin{itemize}
                ...
                Ảnh màu độ phân giải cao, thu thập thực tế từ UAV tại khu vực khảo sát.
            \end{itemize}
        \end{column}
    ...
    \vspace{0.1cm} % Giảm khoảng cách giữa các hàng cho vừa trang
    ...
    \begin{columns}[c]
        \begin{column}{0.65\textwidth}
            \begin{itemize}
                ...
                Chỉ phát hiện các hư hỏng vật lý quan sát được trên bề mặt tấm pin.
            \end{itemize}
        \end{column}
        \begin{column}{0.33\textwidth}
            \centering
