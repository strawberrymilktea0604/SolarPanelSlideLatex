\begin{frame}
    ...
    \begin{tikzpicture}[remember picture, overlay]
        % 1. Xác định tâm của hình tròn - bên trái, thấp hơn để tránh che header
        % Dịch sang trái và giảm kích thước
        \coordinate (centerPoint) at ($(current page.west) + (0.04\paperwidth, -0.7cm)$);
