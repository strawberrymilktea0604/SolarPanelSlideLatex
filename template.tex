...
\usepackage{lmodern} % Latin Modern font - hỗ trợ tốt T5 encoding
% Dùng font mặc định của beamer với lmodern cho tiếng Việt
\usepackage{graphicx}
\usepackage{xcolor}
\usepackage{tikz}
\usepackage{pifont}
...
%---------------------------------------------------------
\title[Mã số: CĐ-2025-07]{\normalsize BÁO CÁO TỔNG KẾT ĐỀ TÀI NGHIÊN CỨU KHOA HỌC SINH VIÊN \texorpdfstring{\\}{} NĂM HỌC 2025-2026}
\subtitle{\scriptsize NGHIÊN CỨU ỨNG DỤNG TRÍ TUỆ NHÂN TẠO TRONG XỬ LÝ HÌNH ẢNH ĐỂ PHÁT HIỆN CÁC HƯ HỎNG CỦA TẤM PIN NĂNG LƯỢNG MẶT TRỜI PHỤC VỤ CÔNG TÁC ĐÁNH GIÁ CHẤT LƯỢNG \texorpdfstring{\\}{} Mã số: CĐ-2025-07}
