...
\tcbset{
    limitationbox/.style={
        ...
        colframe=mainblue,
        boxrule=0pt,
        leftrule=4pt, % Tạo đường kẻ xanh bên trái
        arc=5pt,
...
\begin{frame}[shrink] 
    ...
    \centering
    % Kéo nội dung lên sát tiêu đề hơn (ép khoảng trắng trên cùng)
    
    % Giảm nhẹ font chữ số to một chút (từ 45 xuống 40) để an toàn
    {\fontsize{40}{45}\selectfont \textbf{\textcolor{myRed}{96.45\%}}}
    
    % Khoảng cách giữa số % và chữ Accuracy (ép nhỏ lại)
    \vspace{0.1em}
    {\Large \textcolor{myTextBlue}{Accuracy}}
    
    % Khoảng cách giữa tiêu đề và bảng (ép từ 0.5cm xuống 0.2cm)
    \vspace{0.2cm} 
    
    % Tinh chỉnh bảng
    \renewcommand{\arraystretch}{1.15} % Giảm chiều cao dòng (ép dòng bảng)
    ...
    \begin{tabular}{l r}
        ...
        \textcolor{myTextBlue}{Số tham số (triệu)} & \textcolor{myTextBlue}{7.70} \\
        \textcolor{myTextBlue}{Thời gian huấn luyện (phút)} & \textcolor{myTextBlue}{33.95} \\
        
    \end{tabular}
\end{frame}

\begin{frame}
    \frametitle{KẾT QUẢ PHÂN LOẠI (591 MẪU)}
            ...
            \begin{columns}[T]
                \begin{column}{0.49\textwidth}
                    \begin{tcolorbox}[colback=red!10, colframe=red!60!black, 
                        ...
                        boxrule=0.5mm, arc=1.5mm, left=1pt, right=1pt, top=2pt, bottom=2pt,
                        halign=flush left]
                        \textbf{Bỏ sót:} Vết nứt siêu nhỏ hoặc bị khuất bóng.
                    \end{tcolorbox}
                \end{column}
                ...
                \begin{column}{0.49\textwidth}
                    \begin{tcolorbox}[colback=orange!10, colframe=orange!60!black, 
                        ...
                        boxrule=0.5mm, arc=1.5mm, left=1pt, right=1pt, top=2pt, bottom=2pt,
                        halign=flush left]
                        \textbf{Báo nhầm:} Do lóa sáng hoặc phản chiếu mặt kính.
                    \end{tcolorbox}
                \end{column}
            \end{columns}
...
\label{Bieudo}
	...
	\begin{center}
		\includegraphics[width=0.8\textwidth]{images/TongKet/bieudo.png}
	\end{center}
\end{frame}
...
\label{Test}
	...
	\begin{center}
		\includegraphics[width=0.8\textwidth]{images/TongKet/test.png}
	\end{center}
\end{frame}
...
\begin{frame}
    ...
    \begin{tabularx}{\textwidth}{|>{\centering\arraybackslash}X|*{5}{>{\centering\arraybackslash}X|}}
        ...
        \hhline{|-|-|-|-|-|-|}
        % Dùng lệnh thủ công để đảm bảo đường kẻ dọc không bị màu đè
    ...
    \begin{columns}[t] % Căn lề trên để tránh bị lệch dòng
        ...
        \begin{column}{0.48\textwidth}
            \begin{tcolorbox}[
                ...
                sharp corners, 
                boxrule=0pt, 
                leftrule=3pt, % Tạo đường kẻ dọc bên trái
                boxsep=2pt,
                left=5pt,
                right=5pt,
                top=5pt,
    ...
    \begin{columns}[t, onlytextwidth]
        ...
        \begin{column}{0.31\textwidth}
            \begin{featurebox}
                ...
                \textbf{\small Triển khai Edge AI} \vspace{0.2cm}
                
                \scriptsize Tích hợp mô hình lên thiết bị nhúng gắn trực tiếp trên Drone để xử lý tại biên.
            \end{featurebox}
        \end{column}
