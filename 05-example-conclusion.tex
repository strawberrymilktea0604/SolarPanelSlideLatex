...
\begin{frame} 
    ...
    \begin{columns}[c] % Căn giữa theo chiều dọc
        ...
        \begin{column}{0.4\textwidth}
            \centering
            \hspace{1cm} % Di chuyển sang phải
            % Giữ nguyên font to
...
\label{Test}
	...
	\begin{center}
		\includegraphics[width=0.9\textwidth]{images/TongKet/test.png}
	\end{center}
	\vspace{-0.2cm}
	\centering
    \small
	Mô hình không chỉ đạt kết quả tốt về mặt số liệu mà còn \textcolor{red}{\textbf{hoạt động ổn định trên dữ liệu thực tế}}.
\end{frame}
...
\label{Demo1}
	...
	\centering
    \small
	Hệ thống không chỉ \textcolor{red}{\textbf{phân loại chính xác}} mà còn \textcolor{red}{\textbf{xác định được vị trí}} cụ thể của tấm pin lỗi, rất thuận lợi cho công tác kiểm tra và bảo trì thực tế.
\end{frame}
...
\begin{frame}
    ...
    \arrayrulecolor{black} % Đảm bảo màu viền là đen (do ở trên đã set gray!40)
    ...
    \vspace{0.15cm}
    \textcolor{red}{\textbf{Nhận Xét:}}
    \begin{itemize}
        \item EfficientNet-B2 đạt độ chính xác cao nhất (\textbf{96.45\%}).
    ...
    \begin{columns}[t] % Căn lề trên để tránh bị lệch dòng
        ...
        \begin{column}{0.48\textwidth}
            \begin{tcolorbox}[
                ...
                \begin{itemize}
                    \item Xây dựng thành công quy trình tự động: Thu thập $\rightarrow$ Cắt ảnh $\rightarrow$ Phân loại.
                    \item Thuật toán tách chiết đạt độ chính xác cao (\textbf{\textcolor{myRed}{96.9\%}}).
                    \item Mô hình AI (EfficientNet-B2) đạt độ chính xác \textbf{\textcolor{myRed}{96.45\%}}, vượt trội so với các mô hình nền tảng khác.
                \end{itemize}
            \end{tcolorbox}
        \end{column}
        ...
        \begin{column}{0.48\textwidth}
            \begin{tcolorbox}[
                ...
                \begin{itemize}
                    \item Chứng minh tính khả thi của việc sử dụng ảnh RGB và CNN hạng nhẹ.
                    \item Giảm thiểu chi phí và rủi ro cho công tác bảo trì.
                    \item Nền tảng cho các hệ thống giám sát thời gian thực.
                \end{itemize}
            \end{tcolorbox}
        \end{column}
    ...
    \begin{columns}[t]
        ...
        \begin{column}{0.31\textwidth}
            \begin{tcolorbox}[limitationbox]
                ...
                Mới chỉ phân biệt được "Lỗi" và "Bình thường". Chưa định danh cụ thể loại lỗi và chưa định vị tọa độ lỗi trên tấm pin.
            \end{tcolorbox}
        \end{column}
        ...
        \begin{column}{0.31\textwidth}
            \begin{tcolorbox}[limitationbox]
                ...
                Không phát hiện được các lỗi nhiệt hoặc lỗi bên trong tế bào nếu không có biểu hiện ra bề mặt.
            \end{tcolorbox}
        \end{column}
    \end{columns}
\end{frame}
    ...
    \begin{columns}[t, onlytextwidth]
        ...
        \begin{column}{0.31\textwidth}
            \begin{featurebox}
                ...
                \textbf{\small Đa Phương Thức} \vspace{0.2cm}
                
                \scriptsize Kết hợp ảnh nhiệt để phát hiện các lỗi vô hình như Hotspots, PID bên trong cell.
            \end{featurebox}
        \end{column}
        ...
        \begin{column}{0.31\textwidth}
            \begin{featurebox}
                ...
                \scriptsize Kết hợp tọa độ pixel của tấm pin với GPS và layout nhà máy để ánh xạ đúng vị trí thực tế, giúp kỹ thuật viên xác định nhanh điểm cần kiểm tra.
            \end{featurebox}
        \end{column}
        ...
        \begin{column}{0.31\textwidth}
            \begin{featurebox}
                ...
                \scriptsize Chuyển từ Phân loại sang Phát hiện đối tượng để khoanh vùng chính xác vị trí lỗi.
            \end{featurebox}
        \end{column}
